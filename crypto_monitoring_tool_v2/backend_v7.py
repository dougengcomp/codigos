...
def add_coin():
    ...
    try:
        ...
        # Check if the coin is already being monitored
...
def clear_database():
    try:
        ...
        monitored_coins_collection.delete_many({})  # Deletes monitored coins as well
...
def set_alert():
    try:
        ...
        # Check if an alert with the same parameters already exists
